...
class AreasControllerTest < ActionController::TestCase
  ...
  test "should create area" do
    assert_difference('Area.count') do
      post :create, area: { description: @area.description, merchant_id: @area.merchant_id, name: @area.name }
    end
  ...
  test "should update area" do
    patch :update, id: @area, area: { description: @area.description, merchant_id: @area.merchant_id, name: @area.name }
    assert_redirected_to area_path(assigns(:area))
  end
