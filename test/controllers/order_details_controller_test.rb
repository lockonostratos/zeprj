...
class OrderDetailsControllerTest < ActionController::TestCase
  ...
  test "should create order_detail" do
    assert_difference('OrderDetail.count') do
      post :create, order_detail: { discount_cash: @order_detail.discount_cash, order_id: @order_detail.order_id, price: @order_detail.price, product_id: @order_detail.product_id, quality: @order_detail.quality, return_quality: @order_detail.return_quality }
    end
  ...
  test "should update order_detail" do
    patch :update, id: @order_detail, order_detail: { discount_cash: @order_detail.discount_cash, order_id: @order_detail.order_id, price: @order_detail.price, product_id: @order_detail.product_id, quality: @order_detail.quality, return_quality: @order_detail.return_quality }
    assert_redirected_to order_detail_path(assigns(:order_detail))
  end
