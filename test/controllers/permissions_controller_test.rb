...
class PermissionsControllerTest < ActionController::TestCase
  ...
  test "should create permission" do
    assert_difference('Permission.count') do
      post :create, permission: { permission_key: @permission.permission_key, permission_name: @permission.permission_name }
    end
  ...
  test "should update permission" do
    patch :update, id: @permission, permission: { permission_key: @permission.permission_key, permission_name: @permission.permission_name }
    assert_redirected_to permission_path(assigns(:permission))
  end
