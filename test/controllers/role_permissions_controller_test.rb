...
class RolePermissionsControllerTest < ActionController::TestCase
  ...
  test "should create role_permission" do
    assert_difference('RolePermission.count') do
      post :create, role_permission: { active: @role_permission.active, permission_id: @role_permission.permission_id, role_id: @role_permission.role_id }
    end
  ...
  test "should update role_permission" do
    patch :update, id: @role_permission, role_permission: { active: @role_permission.active, permission_id: @role_permission.permission_id, role_id: @role_permission.role_id }
    assert_redirected_to role_permission_path(assigns(:role_permission))
  end
